...
The interactive API documentation generated by FastAPI.
...
![Register User](screenshots/register-endpoint.png)

---

## 🔐 Login

![Login](screenshots/login-endpoint.png)
...
![Expense Summary](screenshots/expenses-endpoint.png)
